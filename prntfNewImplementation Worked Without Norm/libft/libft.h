 ...
 * // The result will be 0 since 128 is not a valueid ASCII character.
 */
 ...
 * @return int The uppercase equivalueent of `c`, or `c`
 ...
 *
 * @param c The character to convert.
 * @return int The lowercase equivalueent of `c`, or `c`
