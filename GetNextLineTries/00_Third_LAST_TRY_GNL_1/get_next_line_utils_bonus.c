...
/*   Updated: 2024/10/25 11:14:40 by ahirzall         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	gnl_read_file_extra(t_gnl *gnl, long r, t_modes_e mode)
{
	if (mode == LINE_SETTING_UP)
	{
		r = -1;
...
{
	gnl_read_file_extra(gnl, r, INITIALIZATION);
	r = 1;
	...
	gnl_read_file_extra(gnl, r, LINE_SETTING_UP);
}
